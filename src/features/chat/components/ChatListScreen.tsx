...
type TabId = "all" | "personal" | "groups";
type NavId = "chats" | "projects" | "notifications";

// Заглушки для демонстрации интерфейса
const mockChats = [
    {
        id: 1,
        name: "Дипломный проект: UI/UX",
        lastMessage: "Пожалуйста, проверьте последние изменения...",
        time: "14:30",
        unread: 2,
    ...
    {
        id: 2,
        name: "Курсовая: Backend",
        lastMessage: "Вы: Я залил обновление API.",
        time: "Вчера",
        unread: 0,
    ...
    {
        id: 3,
        name: "Обсуждение задач",
        lastMessage: "Скриншот ошибки во вложении",
        time: "10:15",
        unread: 5,
        ...
        <div className="flex h-screen w-full max-w-[1440px] mx-auto bg-[#F8FAFC] dark:bg-[#0F172A] font-['Inter'] transition-colors duration-500">
            ...
            <div className="flex flex-col w-full md:w-[350px] bg-white dark:bg-[#1E293B] border-r border-gray-200 dark:border-gray-800 h-full transition-colors duration-500 shadow-[2px_0_8px_rgba(0,0,0,0.02)] z-10">
                ...
                <div className="p-5 flex justify-between items-center">
                    <div className="flex items-center gap-2 group cursor-pointer">
                        ...
                        <h1 className="text-xl font-bold text-[#007BFF] dark:text-blue-400 tracking-tight">
                            EduChat
                        </h1>
                    </div>
                ...
                <div className="px-5 flex gap-2 mb-2">
                    {[
                        { id: "all" as TabId, label: "Все" },
                        { id: "personal" as TabId, label: "Личные" },
                        { id: "groups" as TabId, label: "Группы" },
                    ].map((tab) => (
                        <button
                            key={tab.id}
                ...
                <div className="flex-1 overflow-y-auto px-3 space-y-1 no-scrollbar">
                    {mockChats.map((chat) => (
                        ...
                        >
                            <div
                                className={`w-12 h-12 rounded-full flex-shrink-0 flex items-center justify-center font-bold text-lg shadow-sm transition-transform duration-300 group-hover:scale-105 ${chat.avatarBg}`}
                            >
                                {chat.name.charAt(0)}
                            </div>
                ...
                <div className="flex justify-around items-center p-3 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-[#1E293B] transition-colors duration-500">
                    ...
                    >
                        <MessageSquare
                            className={`w-6 h-6 mb-1 ${activeNav === "chats" ? "fill-blue-50" : ""}`}
                        />
                    ...
                    >
                        <Folder
                            className={`w-6 h-6 mb-1 ${activeNav === "projects" ? "fill-blue-50" : ""}`}
                        />
                    ...
                    >
                        <Bell
                            className={`w-6 h-6 mb-1 ${activeNav === "notifications" ? "fill-blue-50" : ""}`}
                        />
            ...
            <div className="hidden md:flex flex-1 flex-col items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center hover:-translate-y-2 transition-transform duration-500 cursor-default">
                    ...
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2 transition-colors duration-500">
                        Выберите чат
                    </h2>
